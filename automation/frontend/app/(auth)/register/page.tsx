          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" required className="input-field pl-10" placeholder="Muhammad Talha"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPw ? "text" : "password"} required className="input-field pl-10 pr-10"
